...
class LiveNote():
    ...
    def __init__(self, ref, params, debug_params, wav_to_seq=wav_to_chroma, wav_to_seq_live=wav_to_chroma_col, min_len=fft_len):
        ...
        self.seq_ref = wav_to_seq(ref)

        self.wav_to_seq_live = wav_to_seq_live
    ...
    def insert(self, live_audio_buf):
        ...
        while len(self.buf) >= self.min_len:
            ...
            self.seq_live[:, self.live_ptr] = self.wav_to_seq_live(self.buf[:self.min_len])
